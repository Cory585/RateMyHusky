...
def test_chat_question_mode_requires_account(chat_client):
    # question mode is account-gated: an unauthenticated request is rejected (401)
    # before the orchestrator is ever reached.
