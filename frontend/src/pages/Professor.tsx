      ...
      <section className="prof-section prof-reviews-section" ref={reviewsRef}>
        <div className="prof-reviews-header">
          ...
          <div className="prof-review-tabs" ref={reviewTabsRef}>
            ...
            <button className={`prof-review-tab prof-review-tab-reddit ${reviewTab === 'reddit' ? 'active' : ''}`} onClick={() => setReviewTab('reddit')}>
              Reddit ({MOCK_REDDIT_POSTS.length})
            </button>
          </div>
        </div>
                ...
                <div key={post.id} className="prof-review-card prof-reddit-card">
                  <div className="prof-review-top">
                    ...
                    <div className="prof-review-meta">
                      ...
                      <span className="prof-review-date">{new Date(post.date).toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}</span>
                    </div>
                  </div>
